...
<!-- PRE LOADER -->
                    ...
                    <ul class="nav navbar-nav navbar-nav-first">
                        ...
                        <!--  <li><a href="job-listing.html">Jobs</a></li> -->
                         <li><a href="<?php echo site_url('Aboutus')?>">About Us</a></li>
                          <li class="active"><a href="<?php echo site_url('Signup')?>">Signup</a></li>
	...
	<form  method="POST" action="Signup/show">
	<center>
	<table>
		<tr>
		<td>
		...
		<td>
        		<input type="text" name="contact" value="" placeholder="Enter 10 digits number" pattern="[7-9]{1}[0-9]{9}">
		</td>
		</tr>
		<tr><td><br></td></tr>
		...
		<td>
        		Provider<input type="radio" name="U_Type" value="1"required>&nbsp;&nbsp;
			
        		Finder<input type="radio" name="U_Type" value="2" required>
		</td>
		</tr>
		<tr><td><br></td></tr>
		<tr>
