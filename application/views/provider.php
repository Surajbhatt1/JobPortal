...
<!-- PRE LOADER -->
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                     ...
                     <!--     <li><a href="job-listing.html">Jobs</a></li> -->
                         ...
                         <li><a href="<?php echo site_url('Applier')?>">Applier</a></li>
	...
	<form  method="POST" action="Provider/show">
	<center>
	<table>
		<tr>
		<td>
		...
		<td>
        		<input type="textarea" name="job_desc" rowspan="2" value="" required >
		</td>
