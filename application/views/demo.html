     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
              ...
              <!--            <li><a href="job-listing.html">Jobs</a></li> -->
                         <li class="active"><a href="<?php echo site_url('Aboutus')?>">About Us</a></li>
          ...
          <div class="container">
               ...
               <p class="lead" style="color:Black;">
                    In This Online Job Portal, We Deal with the model day problems like in todays time most Important things is job for a common man and here is the platform which solves your problem.In our Online Job Portal we have interface for both the Job Seeker's and for Job Provider's.   
               </p>

                <p class="lead" style="color:Black;">
                    Our Platform is build in MVC framework and Our Company works for the better and best, if you have any queries then Contact us.
               </p>
          </center>
     </div>
          </div>
