...
<div>
  <?php
     ...
     <center><h1>Apply Page</h1></center>
		<form  method="POST" action="Apply/insert">
	<center>
	<table>
    ...
    <td>
            <input type="text" name="job_u_id" value="<?php echo $Jobs->job_u_id; ?>" required >
    </td>
    ...
    <tr><td><br></td></tr>
		...
		<td>
        		<input type="textarea" name="name" value="" required >
		</td>
		...
		<td>
        		<input type="textarea" name="email" rowspan="2" value="" required >
		</td>
		...
		<td>
        		<input type="textarea" name="contact" value="" required >
		</td>
		...
		<td>
        		<input type="text" name="job_title" value="<?php echo $Jobs->job_title; ?>" required >
		</td>
		</tr>
		<tr><td><br></td></tr>
		...
		<td>
        		<input type="textarea" name="job_desc" value="<?php echo $Jobs->job_description; ?>" required >
		</td>
		...
		<td>
        		<input type="textarea" name="skills" value="" required >
		</td>
